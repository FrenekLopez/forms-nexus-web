...
// ==========================================
// 2. DYNAMIC DATA & ANIMATION VARIANTS (Injected from Resume)
// ==========================================
...
const projectsData: ProjectItem[] = [
  ...
  },
  {
    ...
    githubUrl: "https://github.com/FrenekLopez/freneklopez-dev"
  }
];

// Framer Motion Variants for smooth enter animations
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#0f1624] text-slate-300 font-sans selection:bg-blue-500/30 relative overflow-hidden">
      ...
      >
        <a href="https://www.linkedin.com/in/eric-lopez-650196348/" target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-blue-500 hover:-translate-y-1 transition-all duration-300 focus-visible:outline-none focus-visible:text-blue-500" aria-label="LinkedIn">
          <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
        </a>
        <a href="https://github.com/FrenekLopez" target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-blue-500 hover:-translate-y-1 transition-all duration-300 focus-visible:outline-none focus-visible:text-blue-500" aria-label="GitHub">
        ...
        <a href="https://x.com/LrFrenek" target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-blue-500 hover:-translate-y-1 transition-all duration-300 focus-visible:outline-none focus-visible:text-blue-500" aria-label="X">
      ...
      >
        <div className="text-xl font-bold text-white tracking-widest">
          ERIC OMEGA <span className="text-blue-500">.</span>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-6 flex flex-col gap-32 pb-16 md:pl-28">
        ...
        >
          ...
          <div className="flex gap-4 mb-16 bg-[#131b2c] p-2 rounded-full border border-slate-800/50">
            <button onClick={() => setActiveTab("experience")} className={`px-6 py-2.5 rounded-full text-sm font-bold transition-all duration-300 flex items-center gap-2 ${activeTab === "experience" ? "bg-[#1a2332] text-blue-400 border border-blue-500/50 shadow-[0_0_15px_rgba(59,130,246,0.2)]" : "text-slate-500 hover:text-slate-300 transparent border border-transparent"}`}>
            ...
            <button onClick={() => setActiveTab("education")} className={`px-6 py-2.5 rounded-full text-sm font-bold transition-all duration-300 flex items-center gap-2 ${activeTab === "education" ? "bg-[#1a2332] text-blue-400 border border-blue-500/50 shadow-[0_0_15px_rgba(59,130,246,0.2)]" : "text-slate-500 hover:text-slate-300 transparent border border-transparent"}`}>
          ...
          >
            {currentTimelineData.map((item) => (
              <motion.div variants={staggerItem} key={item.id} className="flex flex-col md:flex-row gap-4 md:gap-8 items-start border-b border-slate-800/50 pb-10 last:border-0 hover:bg-slate-800/10 p-4 rounded-xl transition-colors">
          ...
          <div className="flex flex-col md:flex-row gap-16 items-start">
            ...
            <div className="flex-1 w-full">
              <form ref={formRef} action={handleFormSubmit} className="flex flex-col gap-8">
                ...
                <textarea name="message" required rows={1} disabled={isSubmitting} placeholder="Message" className="w-full bg-transparent border-b border-slate-700 pb-3 text-white placeholder-slate-500 focus:outline-none focus:border-blue-500 focus:ring-0 resize-none overflow-hidden disabled:opacity-50 disabled:cursor-not-allowed transition-all"></textarea>
                <div className="pt-4">
        ...
        <footer className="border-t border-slate-800/50 mt-16 pt-8 pb-4">
          <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-5">
              <a href="https://github.com/FrenekLopez" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-blue-500 hover:-translate-y-1 transition-all duration-300 focus-visible:outline-none focus-visible:text-blue-500" aria-label="GitHub"><svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12"/></svg></a>
              <a href="https://www.linkedin.com/in/eric-lopez-650196348/" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-blue-500 hover:-translate-y-1 transition-all duration-300 focus-visible:outline-none focus-visible:text-blue-500" aria-label="LinkedIn"><svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg></a>
            </div>
          </div>
        </footer>
      </div>
