...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#0f1624] text-slate-300 font-sans selection:bg-orange-500/30 relative overflow-hidden">
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-end gap-6 mb-12">
            ...
            <div className="hidden md:flex gap-4">
              <button onClick={() => scrollCarousel("left")} className="w-12 h-12 rounded-full border border-slate-700 bg-[#1a2332] flex items-center justify-center text-white hover:bg-orange-500 hover:border-orange-500 transition-all group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500" aria-label="Scroll left">
              ...
              <button onClick={() => scrollCarousel("right")} className="w-12 h-12 rounded-full border border-slate-700 bg-[#1a2332] flex items-center justify-center text-white hover:bg-orange-500 hover:border-orange-500 transition-all group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500" aria-label="Scroll right">
          ...
          <div ref={carouselRef} className="flex gap-6 overflow-x-auto snap-x snap-mandatory pb-8 pt-4 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden scroll-smooth">
            {projectsData.map((project) => (
              <div key={project.id} className="min-w-[85vw] md:min-w-[450px] snap-center group relative bg-[#131b2c] rounded-[2rem] p-8 md:p-10 border border-slate-800/60 hover:border-orange-500/40 transition-all duration-500 overflow-hidden shrink-0 flex flex-col justify-between">
                ...
                <div>
                  <div className="flex justify-between items-start mb-6">
                    <span className="text-5xl font-black text-slate-800/50 group-hover:text-orange-500/20 transition-colors">{project.number}</span>
                    <span className="text-xs font-bold uppercase tracking-widest text-slate-500">Backend</span>
                  </div>
                  <h4 className="text-2xl font-bold text-white mb-4 group-hover:text-orange-400 transition-colors">{project.title}</h4>
                ...
                <div>
                  ...
                  <a href={project.githubUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full bg-slate-800/50 text-white text-sm font-bold hover:bg-orange-500 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 group/btn">
                    View Project 
